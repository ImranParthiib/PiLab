...
const Home = () => {
  return (
    <div className="bg-gradient-to-b from-purple-50 to-white dark:from-gray-800 dark:to-gray-900">
      ...
      {/* Features Section */}
      <section className="py-16 px-4 sm:px-6 lg:px-8 bg-white dark:bg-gray-800" id="services">
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {[
              ...
              {
                icon: <Cpu className="h-8 w-8 text-purple-500 dark:text-purple-400" />,
              ...
              },
              {
                ...
                title: "IoT Solutions",
                description: "Connecting devices for smarter, data-driven decisions"
              }
            ].map((feature, index) => (
              <div key={index} className="bg-purple-50 dark:bg-gray-700 rounded-lg p-6 hover:shadow-lg transition duration-300 ease-in-out">
